...
export { clampNumber, coerceId, coerceStoredText, coerceString, isPlainObject, mintId } from './coerce.js';
...
export function sanitizeLoadedData(d) {
    ...
    zArr = zArr
        ...
        .map((z, idx) => ({
            ...
            arabic: coerceStoredText(z.arabic),
            target: clampNumber(z.target, { min: 1, max: 1000000, fallback: 33 }),
            meaning: coerceStoredText(z.meaning),
            ...
            fazilet: z.fazilet != null ? coerceStoredText(z.fazilet) : undefined,
            ...
            .map((x) => ({
                ...
                zikir: x.zikir && isPlainObject(x.zikir)
                    ? {
                        ...
                        arabic: coerceStoredText(x.zikir.arabic),
                        target: clampNumber(x.zikir.target, { min: 1, max: 1000000, fallback: 33 }),
                        meaning: coerceStoredText(x.zikir.meaning),
