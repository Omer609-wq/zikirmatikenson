 ...
 * Proje kökünde .env.local (commit'lenmez) — örnek: .env.local.example
 *   VITE_REVENUECAT_API_KEY_ANDROID=goog_...
 *   VITE_REVENUECAT_API_KEY_IOS=appl_...
 * Boş bırakıldığında satın alma "unavailable" döner (stub mod).
 * Kurulum: docs/REVENUECAT_SETUP.md
 */
const REVENUECAT_API_KEY_ANDROID = String(import.meta.env.VITE_REVENUECAT_API_KEY_ANDROID || '').trim();
const REVENUECAT_API_KEY_IOS = String(import.meta.env.VITE_REVENUECAT_API_KEY_IOS || '').trim();
