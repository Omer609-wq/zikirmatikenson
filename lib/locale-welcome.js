...
const TARGET_LOCALES = new Set(['id', 'ms', 'bn', 'ur', 'ar', 'fr']);
...
/**
 * closeAllOverlays vb. programatik kapanışlar için: açıksa kapat ama "görüldü"
 * işaretleme — kullanıcı okuyamadan kapanmış olabilir (örn. bildirimden açılış,
 * popstate). Mesaj bir sonraki açılışta tekrar denenir; işaretleme yalnızca
 * bilinçli kapatmalarda (Tamam / arka plan / Escape) yapılır.
 */
...
/**
 * Çevirisi gözden geçirilmemiş diller için ilk kez (dil başına bir kez) samimi
 * çeviri notu gösterir. tr ve en dışarıda: ikisi de elden geçmiş durumda.
