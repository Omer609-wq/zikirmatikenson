...
test('hasRestorableCloudBackup detects remote payloads before first upload', () => {
    ...
    assert.equal(hasRestorableCloudBackup({ payload: 'bad' }), false);

    assert.equal(hasRestorableCloudBackup({ payload: {} }), true);
    assert.equal(hasRestorableCloudBackup({ payload: { zikirs: [] } }), true);
});
