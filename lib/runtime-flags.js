const DEFAULT_RUNTIME_FLAGS = Object.freeze({
    ...
    /** Dini gün önizlemesi: gün kimliği ("kadir") ya da true (sıradaki). lib/special-days.js */
    specialDayPreview: false
});
    ...
    runtimeFlagsPromise = (async () => {
        try {
            ...
            runtimeFlags = {
                ...
                specialDayPreview:
                    typeof raw.specialDayPreview === 'string' && raw.specialDayPreview.trim()
                        ? raw.specialDayPreview.trim()
                        : raw.specialDayPreview === true
            };
        } catch {
