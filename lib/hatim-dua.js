 ...
 *
 * İçerik `data/hatim-dua.json` içinde. İki dua ayrı ayrı izlenir:
 * `meta.sharedReview` ortak dua için, `meta.personalReview` kişisel dua için.
 * "verified" ise `meta.sharedReviewScope` neyin doğrulandığını yazar —
 * kaynak metin doğrulanmış olsa bile türetilmiş çeviriler ayrı bir konudur.
 */
