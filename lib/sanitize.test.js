...
test('sanitizeLoadedData preserves rich zikir fields in trash entries', () => {
        ...
        trash: {
            entries: [
                ...
                },
                {
                    kind: 'folder',
                    deletedAt: 124,
                    folder: { id: 'f_saved', name: 'Saved', order: 1 },
                    zikirs: [
                        {
                            id: 'z_library',
                            folderId: 'f_saved',
    ...
    const trashedZikir = sanitized.trash.entries[0].zikir;
    ...
    const folderZikir = sanitized.trash.entries[1].zikirs[0];
