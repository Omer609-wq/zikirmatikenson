/**
 * Aylık ve yıl grafiğinin sayfalara bölünmesi.
 *
 * Ayın 28–31 günü tek ekranda okunmuyor: 30 çubukta etiketler tamamen
 * kalkardı. Bu yüzden ay iki sayfaya bölünüp noktalarla geziliyor.
 *
 * Yılın 12 ayı da aynı sebeple ikiye bölünüyor (6+6): Arapça ve Urducada ay
 * adının kısa biçimi yok ("سبتمبر", "ستمبر"); 12'si yan yana zikrin istatistik
 * penceresine sığmıyor, grafik pencereden taşıyordu.
 *
...
/** Yıl grafiği kaç sayfa: ocak–haziran / temmuz–aralık. */
