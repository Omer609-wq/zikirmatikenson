...
export const APP_QUOTES = [
    ...
    'Benden başka ilah yok; öyleyse Bana kulluk et ve namazı Beni anmak için kıl. (Taha Suresi 14)',
    ...
    'Kim zikrimden yüz çevirirse, ona dar bir geçim verir ve kıyamet günü onu kör olarak haşreder. (Taha Suresi 124)',
    ...
    'Sübhanallahi ve bihamdihi, Sübhanallahil-Azîm dilde hafif, mizanda ağırdır. (Buhari, Müslim)',
    'Dört kelime Allah katında en sevilen sözdür: Sübhanallah, Elhamdülillah, Lâ ilâhe illallah, Allahu ekber. (Müslim)',
    'İman yetmiş küsur şubedir; en üstünü Lâ ilâhe illallah demek, en düşüğü yoldan rahatsızlığı gidermektir. (Müslim)',
